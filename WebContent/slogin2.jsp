			...
			<div class="tang-foreground" style="width: 393px;">
			    ...
			    <div class="tang-body">
			    	<div class="tang-content">
			    		<div class="clearfix">
			    			<div id="" class="pass-login-pop-content">
								<div class="pass-login-pop-form">
									<div id="passport-login-pop-api" class="tang-pass-login">
										<fieldset>
											...
											<form class="form-horizontal" action="${ctx}/download_loginsIn.action"
												method="post">
												
												<s:hidden name="nameIndisk"/>
												<s:hidden name="price"/>
												...
												<div class="form-group">
													<div class="col-sm-offset-4 col-sm-6">
														<s:submit cssClass="button button-flat-primary button-tiny" style="height:32px" value="登录"/>
													</div>
												</div>
											</form>
										</fieldset>
