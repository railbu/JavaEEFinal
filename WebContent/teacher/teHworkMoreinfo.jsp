						...
						<tbody>
							<s:iterator value="hlist" var="item">
								<tr>
										...
										<div class="modal fade" id="myModal<s:property value="id" />"
											...
											<div class="modal-dialog">
												<div class="modal-content">
													...
													<form action="hworkMa_edit" method="post">
														...
														<div class="modal-footer">
															<button type="button" class="button button-flat-caution button-tiny" style="height:32px"
																data-dismiss="modal">Close</button>
															<s:submit value="Save changes" cssClass="button button-flat-primary button-tiny" style="height:32px"/>
														</div>
													</form>
												</div>
												<!-- /.modal-content -->
									...
									<td>
										<s:url value="/teacher/hworkMa_delete" id="delete">
											<s:param name="id" value="id" />
											<s:param name="cid" value="cid" />
										</s:url> 
										
										<s:a href="%{delete}" cssClass="button button-flat-caution button-tiny" style="height:32px;">删除</s:a></td>
								</tr>
							</s:iterator>
						</tbody>
					</table>
